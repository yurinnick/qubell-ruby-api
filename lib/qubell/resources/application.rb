...
module Qubell
  module Resources
    ...
    class Application < Base
      ...
      # @return [Array<Qubell::Resource::Revision>] revisions info
      def revisions
        Qubell::APICall.get("/applications/#{@id}/revisions").map do |rev|
          Qubell::Resources::Revision.new(rev)
        end
      end

      # Get list of all instances for given application.
      # @return [Array<Qubell::Resource::Instance>] revisions info
      def instances
      ...
      # @return [Qubell::Resource::Instance] revisions info
      def launch(args)
