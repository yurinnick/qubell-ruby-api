...
class QubellAPI
  ...
  def organizations
    ...
    .get do |response, request, result, &block|
      return handle_api_responce(response, request, result, &block)
    end
  end
  ...
  def get_applications(org_id)
    ...
    .get do |response, request, result, &block|
      return handle_api_responce(response, request, result, &block, org_id)
    end
  end
  ...
  def get_revisions(app_id)
    ...
    .get do |response, request, result, &block|
      return handle_api_responce(response, request, result, &block, app_id)
    end
  end
  ...
  def get_instances(env_id)
    ...
    .get do |response, request, result, &block|
      return handle_api_responce(response, request, result, &block, env_id)
    end
  end
  ...
  def get_instance_status(instance_id)
    ...
    .get do |response, request, result, &block|
      return handle_api_responce(response, request, result, &block, instance_id)
    end    
  end
  ...
  def upload_user_data(instance_id, userdata)
    ...
    .put(userdata) do |response, request, result, &block|
      return handle_api_responce(response, request, result, &block, instance_id)
    end
  end
  ...
  def destroy_instance(instance_id, force)
    ...
    .delete do |response, request, result, &block|
      return handle_api_responce(response, request, result, &block, instance_id)
    end  
  end
  ...
  def handle_api_responce(response, request, result, &block, resource_id = nil)
    case response.code
    ...
    when 404 then fail ArgumentError, '#{resource_id} doesn’t exist'
